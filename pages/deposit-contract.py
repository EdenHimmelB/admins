...
with col1.expander("Contract Details"):
    ...
    st.text_input(label="Contract ID", key="contract_id")
    st.text_input(label="Bank", key="bank_name")
...
images = st.file_uploader("Image", type=["png", "jpg"], accept_multiple_files=True)
